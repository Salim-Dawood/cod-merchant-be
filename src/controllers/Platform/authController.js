...
async function forgotPassword(req, res, next) {
  try {
    ...
    const result = await passwordResetService.requestReset('platform', email);
...
async function resetPassword(req, res, next) {
  try {
    ...
    const result = await passwordResetService.resetPassword('platform', String(token), String(password));
    if (!result.ok) {
